...
# text_obj = XodexText("Hello", position=(100, 100), color=(0, 255, 0), font_size=40, bold=True)
# text_obj.text = "New Text"
# text_obj.color = (0, 0, 255)
# text_obj.set_position((200, 200))
# text_obj.set_font(font_name="Comic Sans MS", italic=True)
# text_obj.set_alpha(128)
